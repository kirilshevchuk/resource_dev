...
(function () {
    ...
    i.toolbar_Full = [ {
        name: 'clipboard',
        items: ['', '', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo','-','SpellChecker']
    }, {
        name: 'styles',
        ...
        name: 'basicstyles',
        items: ['Bold', 'Italic', 'Underline','-','TextColor','BGColor', '-', 'Subscript', 'Superscript', '-', 'RemoveFormat']
    }, {
        name: 'paragraph',
        ...
        name: 'tools',
        items: ['ShowBlocks', 'Source', 'Maximize', '']
    }/*,'/',{
        name: 'document',
