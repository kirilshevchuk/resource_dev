<?php if (isset($status) && $status=="updatesuccess"){?>
			<div class="infomessage"><?php echo "Empower video has been Uploaded Successfully"?> </div>
...
<style>
    ...
    <div class="content">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Add Empower Video</li>
		</ul>
...
?>
 <form enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/videos/change_emp_video/<?php echo $videodataarray->Id;?>">
