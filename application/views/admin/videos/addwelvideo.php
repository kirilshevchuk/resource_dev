<?php if (isset($status) && $status=="updatesuccess"){?>
			<div class="infomessage"><?php echo "Welcome video has been Uploaded Successfully"?> </div>
...
<style>
    ...
    <div class="content">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Add Welcome Video</li>
		</ul>
...
?>
 <form enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/videos/change_welcome_video/<?php echo $videodataarray->Id;?>">
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home" style="width:50%;float: left;">
        ...
        <label>Welcome Video Description:</label>
	...
	<div id="youtube_link" class="field">
		...
		<!--<label>Upload Welcome video </label>
