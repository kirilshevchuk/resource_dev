<?php if (isset($status) && $status=="updatesuccess"){?>
			<div class="infomessage"><?php echo "Pure Levarege video has been Uploaded Successfully"?> </div>
...
<style>
    ...
    <div class="content">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Add Pure Levarege Video</li>
		</ul>
...
?>
 <form enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/videos/change_pure_lev/<?php echo $videodataarray->Id;?>">
