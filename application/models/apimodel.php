<?php
	Class Apimodel extends CI_Model
	{
		...
		function __construct(){
                    ...
                    $this->compain_name = 'easyaccessprofits';
		...
		function test(){
			...
			$result1 = $client->add_contact(
				...
				array (
					...
					# basic info
					'name'      => 'kiril.shevchuk@yahoo.com',
					'email'     => 'kiril.shevchuk@yahoo.com',
			...
			if(array_key_exists('queued', $result1)){
				if($result1['queued']==1){
					print("<h1><h1>Contact added\n</h1></h1>");
				}
			}else if(array_key_exists('message', $result1)){
				if($result1['message']=='Contact already queued for target campaign'){
