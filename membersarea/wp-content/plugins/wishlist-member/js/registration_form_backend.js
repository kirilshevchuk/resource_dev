...
fields.field_wp_company='<td class="label">Comany:</td><td class="fld_div"><input class="fld" type="text" name="company" size="30" /><div class="desc"></div></td>';
...
function fields_toggle(fld, div){
	fld = jQuery(fld);
	div = jQuery(div);
